...
if (basename(__FILE__) == basename($_SERVER["SCRIPT_FILENAME"])) {
    ...
    <footer class="flex flex-col md:flex-row items-start w-full flex-none self-start p-6 font-medium text-xs text-grey-dark md:items-center justify-between">
        <p><a href="<?php echo env('ext_url'); ?>/mentions.php"><u>Mentions légales</u></a> | <span class="copyleft">&copy;</span> 2020 <i>HiberFile Team</i> & <u><a href="https://github.com/HiberFile/HiberLink/graphs/contributors">Contributors</a></u> | <u><a href="https://github.com/HiberFile/HiberLink/commit/<?php echo get_current_git_commit()?>"><?php echo get_current_git_commit()?></a></u></p>
