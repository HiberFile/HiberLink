                ...
                <h1 class="center">Mentions légales - <?php echo env("title"); ?></h1>
                    ...
                    <div class="overflow-scroll py-8 px-12">
                        ...
                        <ul class="mt-6 leading-normal">
                            ...
                            <li class="mb-4"><b><u>Données Personnelle</u></b>: Voici les données récoltées pour garantir le fonctionnement de <?php echo env("title"); ?>:</li>
                                <ul class="mt-6 leading-normal">
                            ...
                            <li class="mb-4"><b><u>Design</u></b>: L'intégralité du design du site de <?php echo env("title"); ?> est basé sur le design du site de partage de fichiers <a href="https://send.firefox.com"><u>Firefox Send</u></a>, conformément à leurs <a href="https://github.com/mozilla/send/blob/master/LICENSE"><u>mentions légales</u></a>.</li>
